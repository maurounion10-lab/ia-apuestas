...
export const WC_MATCHES = [
  ...
  },
  {
    ...
    rec: 'Gana Argentina', _recSide: 'home',
    conf: 'high', bvr: 5, bvrText: 'Alta',
    stake: 110, odds: 1.78,
    ...
    commenceTs: Date.UTC(2026, 5, 28, 2, 0, 0),
    _sportKey: 'soccer_fifa_world_cup',
    _wcMatch: true,
    probH: 78, probD: 14, probA: 8,
    insight: 'Argentina ya clasificada 1° tras vencer 3-0 a Argelia y 2-0 a Austria sin recibir gol. Jordania ya eliminada (0 puntos, 0 goles a favor en el Mundial). Aún con rotación de Scaloni, el bloque defensivo Otamendi/L.Martínez/E.Martínez sostiene el arco en 0.',
  },
  {
    id: 'wc2026_h6_col_por_27jun',
    ...
    commenceTs: Date.UTC(2026, 5, 27, 23, 30, 0),
    _sportKey: 'soccer_fifa_world_cup',
    _wcMatch: true,
    insight: 'Punteros del Grupo H peleando el 1° puesto. Colombia 4 goles a favor en 2 partidos. Portugal promedia 3 goles por encuentro con Bruno/Bernardo/CR7. Ambas defensas con fragilidades demostradas. Mercado da 51% al BTTS Sí (cuota 1.93).',
  },
  {
    id: 'wc2026_l4_pan_eng_27jun',
    home: 'Panamá', away: 'Inglaterra',
    rec: 'Gana Inglaterra (-1.5)', _recSide: 'away',
    conf: 'high', bvr: 5, bvrText: 'Alta',
    stake: 110, odds: 1.77,
    _hO: 12.00, _dO: 5.00, _aO: 1.30, _bestOdds: 1.77,
    _bookKey: 'dbbet', _bookLabel: 'DBbet',
    result: 'win',
    finalScore: '0-2',
    pl: 84.7,
  ...
  {
    id: 'wc2026_c4_bra_jpn_29jun',
    home: 'Brasil', away: 'Japón',
    rec: 'Gana Brasil', _recSide: 'home',
    conf: 'high', bvr: 5, bvrText: 'Alta',
    stake: 110, odds: 1.55,
    _hO: 1.55, _dO: 3.80, _aO: 5.50, _bestOdds: 1.55,
    _bookKey: 'dbbet', _bookLabel: 'DBbet',
  ...
  },
  {
    ...
    rec: 'Gana Alemania', _recSide: 'home',
    conf: 'high', bvr: 5, bvrText: 'Alta',
    stake: 110, odds: 1.40,
    _hO: 1.40, _dO: 4.20, _aO: 7.00, _bestOdds: 1.40,
    _bookKey: 'dbbet', _bookLabel: 'DBbet',
    result: 'pending',
    league: '🏆 Mundial 2026',
    date: '2026-06-29T20:30:00.000Z',
    commenceTs: ART_ts(2026, 5, 29, 17, 30),
    _sportKey: 'soccer_fifa_world_cup',
    _wcMatch: true,
    probH: 64, probD: 21, probA: 15,
    insight: 'Alemania de Nagelsmann necesita ganar para asegurar el 1° del Grupo E tras vencer Curaçao 7-1 y Ecuador 1-2. Musiala-Wirtz-Havertz-Kimmich en plenitud. Paraguay con 3 puntos peleará pero el plantel es claramente inferior. Histórico: Alemania nunca perdió vs Paraguay en Mundiales.',
  },
  // ════ MAR 30-JUN — OCTAVOS DE FINAL ════
  {
    id: 'wc2026_oct1_ned_mar_30jun',
    ...
    _sportKey: 'soccer_fifa_world_cup',
    _wcMatch: true,
    probH: 48, probD: 28, probA: 24,
    insight: 'Octavo de final. Países Bajos 1° Grupo F (Van Dijk, Frimpong, Gakpo, Xavi Simons) vs Marruecos 2° Grupo C (Hakimi, Mazraoui, Bono). Marruecos siempre incómodo (semifinal Qatar 2022) pero PB con favoritismo y forma. Doble 1X cubre escenario más probable.',
  },
  {
    id: 'wc2026_oct2_fra_swe_30jun',
    home: 'Francia', away: 'Suecia',
    rec: 'Gana Francia', _recSide: 'home',
    conf: 'high', bvr: 5, bvrText: 'Alta',
    stake: 110, odds: 1.55,
    _hO: 1.55, _dO: 3.80, _aO: 5.20, _bestOdds: 1.55,
    _bookKey: 'dbbet', _bookLabel: 'DBbet',
    result: 'pending',
    league: '🏆 Mundial 2026',
    date: '2026-06-30T21:00:00.000Z',
    commenceTs: ART_ts(2026, 5, 30, 18, 0),
    _sportKey: 'soccer_fifa_world_cup',
    _wcMatch: true,
    probH: 56, probD: 26, probA: 18,
